...
public class StackManager : Object {
    ...
    private const string NO_PYTHON_FOUND_VIEW_ID = "no-python-found-view";
    ...
    public void load_views (Gtk.Window window) {
        ...
        stack.add_named (new NoPythonFoundView (), NO_PYTHON_FOUND_VIEW_ID);

        stack.notify["visible-child"].connect (() => {
            var header_bar = HeaderBar.get_instance ();

            if (stack.get_visible_child_name () == NO_PYTHON_FOUND_VIEW_ID) {
